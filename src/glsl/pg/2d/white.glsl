...
int pg_expected(in pg_state this_)
{
    return this_.splats;
}
...
#pragma glslify: export(pg_state)
#pragma glslify: export(pg_seed)
#pragma glslify: export(pg_expected)
#pragma glslify: export(pg_point4)
